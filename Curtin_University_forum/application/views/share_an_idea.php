	...
	<div class="col-md-7 col-md-offset-2">
		<div class="panel panel-default ">
			<div class="panel-heading">
    			<center><h3 class="panel-title"><strong>Share an Idea</strong></h3></center>
    		</div>
        ...
        <br>
  		<div class="form-group">
    		<div class="col-sm-offset-7 col-sm-5">
      			...
      			&nbsp;
      			<?php
      				$registerbtnattributes = array('class' => 'btn btn-primary','name'=>'register_submit','value'=>'Check your Idea');
